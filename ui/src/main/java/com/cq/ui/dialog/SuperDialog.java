...
public class SuperDialog extends IBaseDialog implements IDialog {
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder setScreenWidth(float percentage) {
         ...
         * @return Builder
         */
        public Builder setFullScreenWidth() {
            params.dialogWidth = getScreenWidth((Activity) params.context);
            return this;
        }
        /**
         * 设置屏幕高度百分比
         ...
         * @return Builder
         */
        public Builder setScreenHeight(float percentage) {
